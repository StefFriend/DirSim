...
class HandTrackingGUI(QMainWindow):
    def __init__(self):
        ...
        self.initial_bpm_slider, self.initial_bpm_label = self.create_slider("Initial BPM", INITIAL_BPM, 30, 200)
        self.min_bpm_slider, self.min_bpm_label = self.create_slider("Min BPM", MIN_BPM, 30, 200)
        self.max_bpm_slider, self.max_bpm_label = self.create_slider("Max BPM", MAX_BPM, 30, 200)
